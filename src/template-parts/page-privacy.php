...
get_header();
 ...
 <main id="privacy" class="privacy l-main">

	 <section class="l-pagetitle js-scpoint">
		 <div class="l-pagetitle__text">
			 <h1 class="title m-serif">プライバシー<br>ポリシー</h1>
		 </div>
	 </section>

   <section class="privacy-content">
     <div class="l-container">
       <p class="privacy-content__lead">長田ニット株式会社（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）におけるプライバシー情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
       <div class="privacy-content__block">
         <h2 class="title">第1条（プライバシー情報）</h2>
         <div class="text">
       ...
       <div class="privacy-content__block">
         <h2 class="title">第2条（プライバシー情報の収集方法）</h2>
         <div class="text">
           ...
           <p>当社は、ユーザーについて、利用したサービスやソフトウエア、購入した商品、閲覧したページや広告の履歴、検索した検索キーワード、利用日時、利用方法、利用環境（携帯端末を通じてご利用の場合の当該端末の通信状態、利用に際しての各種設定情報なども含みます）、IPアドレス、クッキー情報、位置情報、端末の個体識別情報などの履歴情報および特性情報を、ユーザーが当社や提携先のサービスを利用、またはページを閲覧する際に収集します。</p>
         </div>
       </div>
       <div class="privacy-content__block">
         <h2 class="title">第3条（個人情報を収集・利用する目的）</h2>
         <div class="text">
       ...
       <div class="privacy-content__block">
         ...
         <div class="text">
           ...
           <p>本人または第三者の生命、身体、財産その他の権利利益を害するおそれがある場合<br>当社の業務の適正な実施に著しい支障を及ぼすおそれがある場合<br>その他法令に違反することとなる場合<br>前項の定めにかかわらず、履歴情報および特性情報などの個人情報以外の情報については、原則として開示いたしません。</p>
         </div>
       </div>
       <div class="privacy-content__block">
         <h2 class="title">第6条（個人情報の訂正および削除）</h2>
         <div class="text">
       ...
       <div class="privacy-content__block">
         <h2 class="title">第7条（個人情報の利用停止等）</h2>
         <div class="text">
       ...
       <div class="privacy-content__block">
         <h2 class="title">第8条（プライバシーポリシーの変更）</h2>
         <div class="text">
           <p>本ポリシーの内容は、ユーザーに通知することなく、変更することができるものとします。当社が別途定める場合を除いて、変更後のプライバシーポリシーは、本ウェブサイトに掲載したときから効力を生じるものとします。</p>
         </div>
       </div>
       <div class="privacy-content__block">
         <h2 class="title">第9条（お問い合わせ窓口）</h2>
         <div class="text">
           <p>本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。</p>
           <p>住所：石川県かほく市鉢伏ト７番地<br>社名：長田ニット株式会社<br>TEL：<a href="tel:0762830917" class="telhref"><span>076-283-0917</span></a>　FAX：076-283-4317</p>
         </div>
       </div>
     </div>
   </section>
